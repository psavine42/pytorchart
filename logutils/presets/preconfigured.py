# from logutils.flexilogger import meter_defs
from logutils.utils import deep_merge, deepcopy
# import pprint
...
class Config(object):
    ...
    @classmethod
    def gen_plot(cls, *keys, phases=_default_phases, plot=None):
    ...
    @classmethod
    def get_presets(cls, *keys, phases=_default_phases):
...
def get_meters(*keys, phases=_default_phases):
    _, meters = get_presets(*keys, phases=phases)
